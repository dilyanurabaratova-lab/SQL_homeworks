...
insert into Employee (id, name, salary, managerId) values ('4', 'Max', '90000', NULL)
	...
	select emp1.Id, emp1.Name,
emp1.ManagerId, emp2.Name,emp1.salary,emp2.salary
from Employee as emp1
LEFT JOIN Employee as emp2
on emp1.ManagerId = emp2.Id
where emp1.salary > emp2.salary

--TASK3 Write a solution to report all the duplicate emails. Note that it''s guaranteed that the email field is not NULL.
...
SELECT 
    o.custid,
    SUM(CASE WHEN o.weight > 50 THEN o.SalesAmount ELSE 0 END) AS TotalSalesAbove50,
...
ORDER BY s.student_id, sub.subject_name,s.student_name
